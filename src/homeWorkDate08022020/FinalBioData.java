...
public class FinalBioData {
    public static void main(String [] args){
        ...
        String HobbiesPlaying = "Cricket";

        System.out.println("Name is: " + Name);
        System.out.println("Education Qualification is: " + EducationQualification);
        System.out.println("Date of Birth is: " + DateOfBirth);
        System.out.println("Language Known is: " + Languageknown);
        System.out.println("Correspondence Address is: " + CorrespondenceAddress);
        System.out.println("Landline No is: " + LandlineNo);
